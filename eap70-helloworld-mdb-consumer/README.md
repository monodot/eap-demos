helloworld-amq-consumer: Helloworld ActiveMQ consumer
=====================================================

Based on the original example provided with the EAP and Wildfly distributions. This just contains the Consumer component.

Original authors: Serge Pagop, Andy Taylor, Jeff Mesnil
Level: Intermediate  
