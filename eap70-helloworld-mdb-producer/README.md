helloworld-amq-producer: Helloworld ActiveMQ producer
=====================================================

Based on the original example provided with the EAP and Wildfly distributions. This just contains the Producer component.
